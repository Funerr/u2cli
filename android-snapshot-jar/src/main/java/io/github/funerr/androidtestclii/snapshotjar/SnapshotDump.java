package io.github.funerr.androidtestclii.snapshotjar;
...
public final class SnapshotDump extends UiAutomatorTestCase {
    private static final String PROTOCOL = "androidtestclii-android-snapshot-jar-v1";
    ...
    private static CaptureResult captureWithUiDeviceDump(UiDevice device) throws Exception {
        String fileName = "androidtestclii-window-dump.xml";
    ...
    private static void emitResult(CaptureResult result) throws Exception {
        ...
        System.out.println("ANDROIDTESTCLII_SNAPSHOT_METADATA_BASE64:" + metadataBase64);
        ...
        for (int i = 0; i < chunkCount; i++) {
            ...
            System.out.println(
                    "ANDROIDTESTCLII_SNAPSHOT_XML_CHUNK:"
                            + i + "/" + chunkCount + ":"
                            + xmlBase64.substring(start, end)
            );
        }
        System.out.println("ANDROIDTESTCLII_SNAPSHOT_DONE");
    }
