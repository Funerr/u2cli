...
- [ ] `TASK-ADA-009`：实现 P1 alert 能力
  - Covers：`REQ-ADA-008`
  - Design：`DES-ADA-008`
  - Verification：`TEST-ADA-025`

- [ ] `TASK-ADA-010`：实现 P1 scroll 和 click 修饰器
  - Covers：`REQ-ADA-008`
  - Design：`DES-ADA-008`
  - Verification：`TEST-ADA-026`、`TEST-ADA-027`

- [ ] `TASK-ADA-011`：增强 appstate、apps、reinstall、keyboard、connect 能力
  - Covers：`REQ-ADA-008`
  - Design：`DES-ADA-008`
  - Verification：`TEST-ADA-028`、`TEST-ADA-029`、`TEST-ADA-030`

- [ ] `TASK-ADA-012`：同步 README 和 Pi schema
  - Covers：`REQ-ADA-009`
  - Design：`DES-ADA-009`
...
- 任何新增错误码必须同步 `u2cli-core` 兼容说明或本 spec 的 compatibility。
