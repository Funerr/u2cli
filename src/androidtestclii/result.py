...
from .capability import capability_metadata, with_capability_metadata
...
class CommandResult:
    ...
    def ok(
        ...
        *,
        ...
        return cls(
            ...
            data=with_capability_metadata(data or {}, command),
    ...
    def failed(
        ...
        *,
        ...
        payload["metadata"] = capability_metadata(command, error=error)
        return cls(
            success=False,
            command=command,
            serial=serial,
